...
class SchedulerOutput:
    ...
    # indexed by kv_cache_group_id. The worker zeros the corresponding GPU
    # memory before the blocks are used, preventing stale NaN/data from
    # corrupting attention or SSM computation. Blocks are grouped because a
    # block ID only addresses the layers of the group that allocated it.
